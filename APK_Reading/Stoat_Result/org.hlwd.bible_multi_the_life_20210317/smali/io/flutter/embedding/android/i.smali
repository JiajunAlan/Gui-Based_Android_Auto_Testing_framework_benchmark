...
.method private constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;Z)V
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/i;->f:Lio/flutter/embedding/engine/h/b;
...
.method private a(II)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/i;->d:Lio/flutter/embedding/engine/h/a;
...
.method static synthetic a(Lio/flutter/embedding/android/i;II)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lio/flutter/embedding/android/i;->a(II)V

    return-void
.end method

.method static synthetic a(Lio/flutter/embedding/android/i;)Z
    .locals 0
...
.method static synthetic b(Lio/flutter/embedding/android/i;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/android/i;->b()V
...
.method static synthetic c(Lio/flutter/embedding/android/i;)V
    ...
    invoke-direct {p0}, Lio/flutter/embedding/android/i;->c()V

    return-void
.end method

.method static synthetic d(Lio/flutter/embedding/android/i;)Lio/flutter/embedding/engine/h/a;
    .locals 0

    iget-object p0, p0, Lio/flutter/embedding/android/i;->d:Lio/flutter/embedding/engine/h/a;
...
.method public a()V
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/i;->f:Lio/flutter/embedding/engine/h/b;

    invoke-virtual {v0, v1}, Lio/flutter/embedding/engine/h/a;->b(Lio/flutter/embedding/engine/h/b;)V

    const/4 v0, 0x0

    iput-object v0, p0, Lio/flutter/embedding/android/i;->d:Lio/flutter/embedding/engine/h/a;
...
.method public a(Lio/flutter/embedding/engine/h/a;)V
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/i;->d:Lio/flutter/embedding/engine/h/a;
    ...
    iget-object v2, p0, Lio/flutter/embedding/android/i;->f:Lio/flutter/embedding/engine/h/b;

    invoke-virtual {v1, v2}, Lio/flutter/embedding/engine/h/a;->b(Lio/flutter/embedding/engine/h/b;)V

    :cond_0
    iput-object p1, p0, Lio/flutter/embedding/android/i;->d:Lio/flutter/embedding/engine/h/a;

    const/4 p1, 0x1

    iput-boolean p1, p0, Lio/flutter/embedding/android/i;->c:Z

    iget-object p1, p0, Lio/flutter/embedding/android/i;->d:Lio/flutter/embedding/engine/h/a;
