...
.method public constructor <init>(Landroid/app/Activity;Lio/flutter/embedding/engine/i/f;)V
    ...
    iget-object p1, p0, Lio/flutter/plugin/platform/c;->b:Lio/flutter/embedding/engine/i/f;

    iget-object p2, p0, Lio/flutter/plugin/platform/c;->e:Lio/flutter/embedding/engine/i/f$h;

    invoke-virtual {p1, p2}, Lio/flutter/embedding/engine/i/f;->a(Lio/flutter/embedding/engine/i/f$h;)V
...
.method private a(Lio/flutter/embedding/engine/i/f$e;)Ljava/lang/CharSequence;
    .locals 3
...
.method static synthetic a(Lio/flutter/plugin/platform/c;Lio/flutter/embedding/engine/i/f$e;)Ljava/lang/CharSequence;
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/c;->a(Lio/flutter/embedding/engine/i/f$e;)Ljava/lang/CharSequence;
...
.method private a(Lio/flutter/embedding/engine/i/f$c;)V
    .locals 6
...
.method private a(Lio/flutter/embedding/engine/i/f$i;)V
    .locals 1

    sget-object v0, Lio/flutter/embedding/engine/i/f$i;->b:Lio/flutter/embedding/engine/i/f$i;
...
.method private a(Lio/flutter/embedding/engine/i/f$j;)V
    .locals 7
...
.method static synthetic a(Lio/flutter/plugin/platform/c;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/plugin/platform/c;->e()V

    return-void
.end method

.method static synthetic a(Lio/flutter/plugin/platform/c;I)V
    .locals 0
...
.method static synthetic a(Lio/flutter/plugin/platform/c;Lio/flutter/embedding/engine/i/f$c;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/c;->a(Lio/flutter/embedding/engine/i/f$c;)V
...
.method static synthetic a(Lio/flutter/plugin/platform/c;Lio/flutter/embedding/engine/i/f$i;)V
    ...
    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/c;->a(Lio/flutter/embedding/engine/i/f$i;)V

    return-void
.end method

.method static synthetic a(Lio/flutter/plugin/platform/c;Lio/flutter/embedding/engine/i/f$j;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/c;->a(Lio/flutter/embedding/engine/i/f$j;)V

    return-void
.end method

.method static synthetic a(Lio/flutter/plugin/platform/c;Ljava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/c;->a(Ljava/lang/String;)V

    return-void
.end method

.method static synthetic a(Lio/flutter/plugin/platform/c;Ljava/util/ArrayList;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/c;->a(Ljava/util/ArrayList;)V

    return-void
.end method

.method static synthetic a(Lio/flutter/plugin/platform/c;Ljava/util/List;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/c;->a(Ljava/util/List;)V
...
.method private a(Ljava/util/List;)V
    ...
    invoke-virtual {p0}, Lio/flutter/plugin/platform/c;->b()V

    return-void
.end method

.method static synthetic b(Lio/flutter/plugin/platform/c;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/plugin/platform/c;->d()V
...
.method static synthetic c(Lio/flutter/plugin/platform/c;)Ljava/util/List;
    .locals 0

    invoke-direct {p0}, Lio/flutter/plugin/platform/c;->c()Ljava/util/List;
...
.method public a()V
    ...
    invoke-virtual {v0, v1}, Lio/flutter/embedding/engine/i/f;->a(Lio/flutter/embedding/engine/i/f$h;)V

    return-void
.end method

.method a(Lio/flutter/embedding/engine/i/f$g;)V
    .locals 3
...
.method public b()V
    ...
    invoke-direct {p0, v0}, Lio/flutter/plugin/platform/c;->a(Lio/flutter/embedding/engine/i/f$j;)V
