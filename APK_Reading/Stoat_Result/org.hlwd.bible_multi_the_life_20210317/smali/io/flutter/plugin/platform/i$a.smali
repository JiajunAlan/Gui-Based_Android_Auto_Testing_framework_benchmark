...
# virtual methods
.method public a(Lio/flutter/embedding/engine/i/g$b;)J
    .locals 11
    .annotation build Landroid/annotation/TargetApi;
        value = 0x11
    .end annotation

    invoke-direct {p0}, Lio/flutter/plugin/platform/i$a;->a()V

    iget v0, p1, Lio/flutter/embedding/engine/i/g$b;->e:I

    invoke-static {v0}, Lio/flutter/plugin/platform/i;->a(I)Z
    ...
    invoke-static {v0}, Lio/flutter/plugin/platform/i;->a(Lio/flutter/plugin/platform/i;)Lio/flutter/plugin/platform/g;
    ...
    invoke-virtual {v4}, Lio/flutter/plugin/platform/e;->a()Lc/a/b/a/g;

    move-result-object v0

    iget-object v1, p1, Lio/flutter/embedding/engine/i/g$b;->f:Ljava/nio/ByteBuffer;

    invoke-interface {v0, v1}, Lc/a/b/a/g;->a(Ljava/nio/ByteBuffer;)Ljava/lang/Object;
    ...
    invoke-static {v0, v1, v2}, Lio/flutter/plugin/platform/i;->a(Lio/flutter/plugin/platform/i;D)I
    ...
    invoke-static {v0, v6, v7}, Lio/flutter/plugin/platform/i;->a(Lio/flutter/plugin/platform/i;II)V

    iget-object v0, p0, Lio/flutter/plugin/platform/i$a;->a:Lio/flutter/plugin/platform/i;

    invoke-static {v0}, Lio/flutter/plugin/platform/i;->c(Lio/flutter/plugin/platform/i;)Lio/flutter/view/e;
    ...
    invoke-static {v1}, Lio/flutter/plugin/platform/i;->d(Lio/flutter/plugin/platform/i;)Landroid/content/Context;

    move-result-object v2

    iget-object v1, p0, Lio/flutter/plugin/platform/i$a;->a:Lio/flutter/plugin/platform/i;

    invoke-static {v1}, Lio/flutter/plugin/platform/i;->e(Lio/flutter/plugin/platform/i;)Lio/flutter/plugin/platform/b;
    ...
    invoke-static/range {v2 .. v10}, Lio/flutter/plugin/platform/j;->a(Landroid/content/Context;Lio/flutter/plugin/platform/b;Lio/flutter/plugin/platform/e;Lio/flutter/view/e$a;IIILjava/lang/Object;Landroid/view/View$OnFocusChangeListener;)Lio/flutter/plugin/platform/j;
    ...
    invoke-static {v2}, Lio/flutter/plugin/platform/i;->f(Lio/flutter/plugin/platform/i;)Landroid/view/View;
    ...
    invoke-virtual {v1, v2}, Lio/flutter/plugin/platform/j;->a(Landroid/view/View;)V
    ...
    invoke-virtual {v1}, Lio/flutter/plugin/platform/j;->b()Landroid/view/View;
    ...
    invoke-static {p1}, Lio/flutter/plugin/platform/i;->g(Lio/flutter/plugin/platform/i;)Ljava/util/HashMap;
    ...
    invoke-interface {v0}, Lio/flutter/view/e$a;->b()J
...
.method public a(I)V
    ...
    invoke-static {v1}, Lio/flutter/plugin/platform/i;->h(Lio/flutter/plugin/platform/i;)Lc/a/b/b/b;
    ...
    invoke-virtual {v1, p1}, Lc/a/b/b/b;->a(I)V

    :cond_0
    iget-object v1, p0, Lio/flutter/plugin/platform/i$a;->a:Lio/flutter/plugin/platform/i;

    invoke-static {v1}, Lio/flutter/plugin/platform/i;->g(Lio/flutter/plugin/platform/i;)Ljava/util/HashMap;

    move-result-object v1

    invoke-virtual {v0}, Lio/flutter/plugin/platform/j;->b()Landroid/view/View;
...
.method public a(II)V
    ...
    invoke-static {p2}, Lio/flutter/plugin/platform/i;->a(I)Z
    ...
    invoke-virtual {p1}, Lio/flutter/plugin/platform/j;->b()Landroid/view/View;
...
.method public synthetic a(Lio/flutter/embedding/engine/i/g$b;Landroid/view/View;Z)V
    .locals 0
    ...
    invoke-static {p2}, Lio/flutter/plugin/platform/i;->b(Lio/flutter/plugin/platform/i;)Lio/flutter/embedding/engine/i/g;

    move-result-object p2

    iget p1, p1, Lio/flutter/embedding/engine/i/g$b;->a:I

    invoke-virtual {p2, p1}, Lio/flutter/embedding/engine/i/g;->a(I)V

    :cond_0
    return-void
.end method

.method public a(Lio/flutter/embedding/engine/i/g$c;Ljava/lang/Runnable;)V
    .locals 5
    ...
    invoke-static {v1, v2, v3}, Lio/flutter/plugin/platform/i;->a(Lio/flutter/plugin/platform/i;D)I
    ...
    invoke-static {v2, v3, v4}, Lio/flutter/plugin/platform/i;->a(Lio/flutter/plugin/platform/i;D)I

    move-result p1

    iget-object v2, p0, Lio/flutter/plugin/platform/i$a;->a:Lio/flutter/plugin/platform/i;

    invoke-static {v2, v1, p1}, Lio/flutter/plugin/platform/i;->a(Lio/flutter/plugin/platform/i;II)V

    iget-object v2, p0, Lio/flutter/plugin/platform/i$a;->a:Lio/flutter/plugin/platform/i;

    invoke-static {v2, v0}, Lio/flutter/plugin/platform/i;->a(Lio/flutter/plugin/platform/i;Lio/flutter/plugin/platform/j;)V
    ...
    invoke-virtual {v0, v1, p1, v2}, Lio/flutter/plugin/platform/j;->a(IILjava/lang/Runnable;)V
...
.method public a(Lio/flutter/embedding/engine/i/g$d;)V
    .locals 21
    ...
    invoke-direct/range {p0 .. p0}, Lio/flutter/plugin/platform/i$a;->a()V

    iget-object v2, v0, Lio/flutter/plugin/platform/i$a;->a:Lio/flutter/plugin/platform/i;

    invoke-static {v2}, Lio/flutter/plugin/platform/i;->d(Lio/flutter/plugin/platform/i;)Landroid/content/Context;
    ...
    invoke-static {v3}, Lio/flutter/plugin/platform/i;->a(Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-static {v3, v2}, Lio/flutter/plugin/platform/i;->a(Ljava/lang/Object;F)Ljava/util/List;
    ...
    invoke-virtual {v2}, Lio/flutter/plugin/platform/j;->b()Landroid/view/View;

    move-result-object v2

    iget-object v3, v1, Lio/flutter/embedding/engine/i/g$d;->b:Ljava/lang/Number;

    invoke-virtual {v3}, Ljava/lang/Number;->longValue()J

    move-result-wide v4

    iget-object v3, v1, Lio/flutter/embedding/engine/i/g$d;->c:Ljava/lang/Number;
    ...
    iget v3, v1, Lio/flutter/embedding/engine/i/g$d;->l:I

    iget v0, v1, Lio/flutter/embedding/engine/i/g$d;->m:I

    move-object/from16 v20, v2

    iget v2, v1, Lio/flutter/embedding/engine/i/g$d;->n:I

    iget v1, v1, Lio/flutter/embedding/engine/i/g$d;->o:I
