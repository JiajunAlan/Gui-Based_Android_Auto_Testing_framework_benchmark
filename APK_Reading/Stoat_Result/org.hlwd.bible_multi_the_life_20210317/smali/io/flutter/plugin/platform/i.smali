...
.field private d:Lio/flutter/view/e;

.field private e:Lc/a/b/b/b;
...
.method static synthetic a(Lio/flutter/plugin/platform/i;D)I
    .locals 0

    invoke-direct {p0, p1, p2}, Lio/flutter/plugin/platform/i;->a(D)I
...
.method static synthetic a(Lio/flutter/plugin/platform/i;)Lio/flutter/plugin/platform/g;
    .locals 0
...
.method static synthetic a(Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-static {p0}, Lio/flutter/plugin/platform/i;->c(Ljava/lang/Object;)Ljava/util/List;
...
.method static synthetic a(Ljava/lang/Object;F)Ljava/util/List;
    ...
    invoke-static {p0, p1}, Lio/flutter/plugin/platform/i;->c(Ljava/lang/Object;F)Ljava/util/List;
...
.method static synthetic a(Lio/flutter/plugin/platform/i;II)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lio/flutter/plugin/platform/i;->a(II)V

    return-void
.end method

.method static synthetic a(Lio/flutter/plugin/platform/i;Lio/flutter/plugin/platform/j;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/i;->a(Lio/flutter/plugin/platform/j;)V

    return-void
.end method

.method private a(Lio/flutter/plugin/platform/j;)V
    .locals 1

    iget-object v0, p0, Lio/flutter/plugin/platform/i;->e:Lc/a/b/b/b;
    ...
    :cond_0
    invoke-virtual {v0}, Lc/a/b/b/b;->d()V

    invoke-virtual {p1}, Lio/flutter/plugin/platform/j;->d()V
...
.method static synthetic a(I)Z
    ...
    invoke-static {p0}, Lio/flutter/plugin/platform/i;->b(I)Z
...
.method private static b(Ljava/lang/Object;F)Landroid/view/MotionEvent$PointerCoords;
    .locals 3
...
.method private static b(Ljava/lang/Object;)Landroid/view/MotionEvent$PointerProperties;
    .locals 2
...
.method static synthetic b(Lio/flutter/plugin/platform/i;)Lio/flutter/embedding/engine/i/g;
    .locals 0
...
.method static synthetic b(Lio/flutter/plugin/platform/i;Lio/flutter/plugin/platform/j;)V
    .locals 0
...
.method private b(Lio/flutter/plugin/platform/j;)V
    ...
    :cond_0
    invoke-virtual {v0}, Lc/a/b/b/b;->e()V

    invoke-virtual {p1}, Lio/flutter/plugin/platform/j;->e()V
...
.method static synthetic c(Lio/flutter/plugin/platform/i;)Lio/flutter/view/e;
    .locals 0

    iget-object p0, p0, Lio/flutter/plugin/platform/i;->d:Lio/flutter/view/e;
...
.method private static c(Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-static {v1}, Lio/flutter/plugin/platform/i;->b(Ljava/lang/Object;)Landroid/view/MotionEvent$PointerProperties;
...
.method private static c(Ljava/lang/Object;F)Ljava/util/List;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v1, p1}, Lio/flutter/plugin/platform/i;->b(Ljava/lang/Object;F)Landroid/view/MotionEvent$PointerCoords;
...
.method static synthetic d(Lio/flutter/plugin/platform/i;)Landroid/content/Context;
    .locals 0
...
.method static synthetic e(Lio/flutter/plugin/platform/i;)Lio/flutter/plugin/platform/b;
    .locals 0
...
.method static synthetic f(Lio/flutter/plugin/platform/i;)Landroid/view/View;
    .locals 0
...
.method static synthetic g(Lio/flutter/plugin/platform/i;)Ljava/util/HashMap;
    .locals 0
...
.method private g()V
    ...
    invoke-virtual {v1}, Lio/flutter/plugin/platform/j;->a()V
...
.method static synthetic h(Lio/flutter/plugin/platform/i;)Lc/a/b/b/b;
    .locals 0

    iget-object p0, p0, Lio/flutter/plugin/platform/i;->e:Lc/a/b/b/b;
...
.method public a()V
    ...
    invoke-virtual {v0, v1}, Lio/flutter/plugin/platform/b;->a(Lio/flutter/view/c;)V

    return-void
.end method

.method public a(Landroid/content/Context;Lio/flutter/view/e;Lio/flutter/embedding/engine/e/a;)V
    .locals 1
    ...
    iput-object p2, p0, Lio/flutter/plugin/platform/i;->d:Lio/flutter/view/e;
    ...
    iget-object p1, p0, Lio/flutter/plugin/platform/i;->f:Lio/flutter/embedding/engine/i/g;

    iget-object p2, p0, Lio/flutter/plugin/platform/i;->j:Lio/flutter/embedding/engine/i/g$e;

    invoke-virtual {p1, p2}, Lio/flutter/embedding/engine/i/g;->a(Lio/flutter/embedding/engine/i/g$e;)V
...
.method public a(Landroid/view/View;)V
    ...
    invoke-virtual {v1, p1}, Lio/flutter/plugin/platform/j;->a(Landroid/view/View;)V
...
.method public a(Lc/a/b/b/b;)V
    .locals 0

    iput-object p1, p0, Lio/flutter/plugin/platform/i;->e:Lc/a/b/b/b;
...
.method public a(Lio/flutter/view/c;)V
    ...
    invoke-virtual {v0, p1}, Lio/flutter/plugin/platform/b;->a(Lio/flutter/view/c;)V
...
.method public b()V
    ...
    invoke-virtual {v0, v1}, Lio/flutter/embedding/engine/i/g;->a(Lio/flutter/embedding/engine/i/g$e;)V
    ...
    iput-object v1, p0, Lio/flutter/plugin/platform/i;->d:Lio/flutter/view/e;
...
.method public d()V
    ...
    iput-object v0, p0, Lio/flutter/plugin/platform/i;->e:Lc/a/b/b/b;

    return-void
.end method

.method public e()Lio/flutter/plugin/platform/f;
    .locals 1
