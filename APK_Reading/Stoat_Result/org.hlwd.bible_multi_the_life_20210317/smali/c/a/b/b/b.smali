...
.method public constructor <init>(Landroid/view/View;Lio/flutter/embedding/engine/e/a;Lio/flutter/plugin/platform/i;)V
    ...
    sget-object v1, Lc/a/b/b/b$b$a;->a:Lc/a/b/b/b$b$a;

    const/4 v2, 0x0

    invoke-direct {v0, v1, v2}, Lc/a/b/b/b$b;-><init>(Lc/a/b/b/b$b$a;I)V

    iput-object v0, p0, Lc/a/b/b/b;->d:Lc/a/b/b/b$b;

    iput-object p1, p0, Lc/a/b/b/b;->a:Landroid/view/View;
    ...
    iput-object p1, p0, Lc/a/b/b/b;->b:Landroid/view/inputmethod/InputMethodManager;
    ...
    iput-object p1, p0, Lc/a/b/b/b;->c:Lio/flutter/embedding/engine/i/j;

    iget-object p1, p0, Lc/a/b/b/b;->c:Lio/flutter/embedding/engine/i/j;

    new-instance p2, Lc/a/b/b/b$a;

    invoke-direct {p2, p0}, Lc/a/b/b/b$a;-><init>(Lc/a/b/b/b;)V
    ...
    iput-object p3, p0, Lc/a/b/b/b;->i:Lio/flutter/plugin/platform/i;

    iget-object p1, p0, Lc/a/b/b/b;->i:Lio/flutter/plugin/platform/i;

    invoke-virtual {p1, p0}, Lio/flutter/plugin/platform/i;->a(Lc/a/b/b/b;)V

    invoke-direct {p0}, Lc/a/b/b/b;->g()Z

    move-result p1

    iput-boolean p1, p0, Lc/a/b/b/b;->j:Z
...
.method static synthetic a(Lc/a/b/b/b;)Landroid/view/View;
    .locals 0

    iget-object p0, p0, Lc/a/b/b/b;->a:Landroid/view/View;
...
.method private a(Landroid/view/View;)V
    ...
    iget-object v0, p0, Lc/a/b/b/b;->b:Landroid/view/inputmethod/InputMethodManager;
...
.method static synthetic a(Lc/a/b/b/b;I)V
    .locals 0

    invoke-direct {p0, p1}, Lc/a/b/b/b;->b(I)V

    return-void
.end method

.method static synthetic a(Lc/a/b/b/b;Landroid/view/View;)V
    .locals 0

    invoke-direct {p0, p1}, Lc/a/b/b/b;->b(Landroid/view/View;)V
...
.method private a(Lio/flutter/embedding/engine/i/j$e;)V
    ...
    iget-object v1, p0, Lc/a/b/b/b;->f:Landroid/text/Editable;
    ...
    :cond_0
    iget-object p1, p0, Lc/a/b/b/b;->f:Landroid/text/Editable;
...
.method private b(I)V
    ...
    iget-object v0, p0, Lc/a/b/b/b;->a:Landroid/view/View;

    invoke-virtual {v0}, Landroid/view/View;->requestFocus()Z

    new-instance v0, Lc/a/b/b/b$b;

    sget-object v1, Lc/a/b/b/b$b$a;->c:Lc/a/b/b/b$b$a;

    invoke-direct {v0, v1, p1}, Lc/a/b/b/b$b;-><init>(Lc/a/b/b/b$b$a;I)V

    iput-object v0, p0, Lc/a/b/b/b;->d:Lc/a/b/b/b$b;

    iget-object p1, p0, Lc/a/b/b/b;->b:Landroid/view/inputmethod/InputMethodManager;
    ...
    iput-boolean p1, p0, Lc/a/b/b/b;->g:Z
...
.method static synthetic b(Lc/a/b/b/b;)V
    .locals 0

    invoke-direct {p0}, Lc/a/b/b/b;->f()V

    return-void
.end method

.method static synthetic b(Lc/a/b/b/b;Landroid/view/View;)V
    .locals 0

    invoke-direct {p0, p1}, Lc/a/b/b/b;->a(Landroid/view/View;)V
...
.method private f()V
    ...
    iget-object v0, p0, Lc/a/b/b/b;->d:Lc/a/b/b/b$b;

    iget-object v0, v0, Lc/a/b/b/b$b;->a:Lc/a/b/b/b$b$a;
    ...
    invoke-virtual {p0}, Lc/a/b/b/b;->e()V
...
.method public a(Landroid/view/View;Landroid/view/inputmethod/EditorInfo;)Landroid/view/inputmethod/InputConnection;
    ...
    iget-object v1, v0, Lc/a/b/b/b$b;->a:Lc/a/b/b/b$b$a;

    sget-object v2, Lc/a/b/b/b$b$a;->a:Lc/a/b/b/b$b$a;

    if-ne v1, v2, :cond_0

    const/4 p1, 0x0

    iput-object p1, p0, Lc/a/b/b/b;->h:Landroid/view/inputmethod/InputConnection;

    return-object p1

    :cond_0
    sget-object v2, Lc/a/b/b/b$b$a;->c:Lc/a/b/b/b$b$a;

    if-ne v1, v2, :cond_2

    iget-boolean p1, p0, Lc/a/b/b/b;->k:Z

    if-eqz p1, :cond_1

    iget-object p1, p0, Lc/a/b/b/b;->h:Landroid/view/inputmethod/InputConnection;
    ...
    :cond_2
    iget-object v0, p0, Lc/a/b/b/b;->e:Lio/flutter/embedding/engine/i/j$b;
    ...
    invoke-static {v1, v2, v3, v4, v0}, Lc/a/b/b/b;->a(Lio/flutter/embedding/engine/i/j$c;ZZZLio/flutter/embedding/engine/i/j$d;)I
    ...
    :goto_0
    iget-object v1, p0, Lc/a/b/b/b;->e:Lio/flutter/embedding/engine/i/j$b;
    ...
    iget-object v1, p0, Lc/a/b/b/b;->d:Lc/a/b/b/b$b;

    iget v3, v1, Lc/a/b/b/b$b;->b:I

    iget-object v4, p0, Lc/a/b/b/b;->c:Lio/flutter/embedding/engine/i/j;

    iget-object v5, p0, Lc/a/b/b/b;->f:Landroid/text/Editable;
    ...
    invoke-direct/range {v1 .. v6}, Lc/a/b/b/a;-><init>(Landroid/view/View;ILio/flutter/embedding/engine/i/j;Landroid/text/Editable;Landroid/view/inputmethod/EditorInfo;)V
    ...
    iput-object v0, p0, Lc/a/b/b/b;->h:Landroid/view/inputmethod/InputConnection;
...
.method public a()V
    ...
    iget-object v0, p0, Lc/a/b/b/b;->i:Lio/flutter/plugin/platform/i;
...
.method public a(I)V
    ...
    new-instance p1, Lc/a/b/b/b$b;

    sget-object v0, Lc/a/b/b/b$b$a;->a:Lc/a/b/b/b$b$a;

    const/4 v1, 0x0

    invoke-direct {p1, v0, v1}, Lc/a/b/b/b$b;-><init>(Lc/a/b/b/b$b$a;I)V

    iput-object p1, p0, Lc/a/b/b/b;->d:Lc/a/b/b/b$b;

    iget-object p1, p0, Lc/a/b/b/b;->a:Landroid/view/View;
    ...
    iput-boolean v1, p0, Lc/a/b/b/b;->g:Z
...
.method a(ILio/flutter/embedding/engine/i/j$b;)V
    ...
    sget-object v1, Lc/a/b/b/b$b$a;->b:Lc/a/b/b/b$b$a;

    invoke-direct {v0, v1, p1}, Lc/a/b/b/b$b;-><init>(Lc/a/b/b/b$b$a;I)V

    iput-object v0, p0, Lc/a/b/b/b;->d:Lc/a/b/b/b$b;

    iput-object p2, p0, Lc/a/b/b/b;->e:Lio/flutter/embedding/engine/i/j$b;
    ...
    iput-object p1, p0, Lc/a/b/b/b;->f:Landroid/text/Editable;
...
.method a(Landroid/view/View;Lio/flutter/embedding/engine/i/j$e;)V
    ...
    iget-object v0, p0, Lc/a/b/b/b;->f:Landroid/text/Editable;
    ...
    :cond_0
    invoke-direct {p0, p2}, Lc/a/b/b/b;->a(Lio/flutter/embedding/engine/i/j$e;)V

    iget-boolean p2, p0, Lc/a/b/b/b;->j:Z

    if-nez p2, :cond_1

    iget-boolean p2, p0, Lc/a/b/b/b;->g:Z

    if-nez p2, :cond_1

    iget-object v2, p0, Lc/a/b/b/b;->b:Landroid/view/inputmethod/InputMethodManager;

    iget-object v3, p0, Lc/a/b/b/b;->a:Landroid/view/View;
    ...
    :cond_1
    iget-object p2, p0, Lc/a/b/b/b;->b:Landroid/view/inputmethod/InputMethodManager;
...
.method public c()Landroid/view/inputmethod/InputConnection;
    ...
    iget-object v0, p0, Lc/a/b/b/b;->h:Landroid/view/inputmethod/InputConnection;
...
.method public d()V
    ...
    iput-boolean v0, p0, Lc/a/b/b/b;->k:Z
